...
import useWindowSize from "./hooks/useWinwodSize";
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/edit/:id" element={<EditPost posts={posts} editTitle={editTitle} editBody={editBody} handleEdit={handleEdit} setEditBody={setEditBody} setEditTitle={setEditTitle} />} />
